...
VALID_STATUS = ('Filming', 'Pre-Production', 'Post-Production', 'Development')
...
class Project(db.Model):
     ...
     status = db.Column(db.String(30), default=VALID_STATUS[0])
...
class ProjectSchema(ma.Schema):
    ...
    status = fields.String(required=True, validate=OneOf(VALID_STATUS))
